...
CREATE TABLE USER (
    ...
    UDELETEYN CHAR(1) NOT NULL DEFAULT 'N', -- 유저 상태 (Y: 탈퇴, N: 정상, B: 정지)
    ...
    UDELETEDATE DATETIME NOT NULL, -- 탈퇴일
...
CREATE TABLE REVIEW (
    ...
    RUPDATE DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, -- 최근 수정일, 현재 시간 자동 입력
...
CREATE TABLE COMMENT (
    ...
    RIDX VARCHAR(12), -- 리뷰글번호, REVIEW 테이블의 외래키
    MID VARCHAR(10) NOT NULL, -- 영화ID, TMDB API에서 제공
...
-- user 테이블에 임의 데이터 삽입
INSERT INTO USER (UIDX, UNAME, UID, UPW, UBIRTH, UGENDER, UPHONE, UADDR1, UADDR2, UMAIL, UDELETEYN, UPOST, UINSERTDATE, UUPDATEDATE, UDELETEDATE, UPROFILE, USAVEPROFILE
) VALUES
